...
function App() {
  ...
  const deleteCourseHandler = async (courseName) => {
    setCourses((prevCourses) =>
      prevCourses.filter((course) => course.course_name !== courseName)
    );
  };
        ...
        <AuthState>
          ...
          <div className="mainDiv">
            <Routes>
              ...
              <Route
                path="/plasma/requesterloginanddelete"
                element={<LoginR />}
              />
